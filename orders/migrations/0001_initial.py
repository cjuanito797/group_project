...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.CreateModel(
            name='GuestOrder',
            fields=[
                ('id', models.CharField(blank=True, default='801797', editable=False, max_length=6, primary_key=True, serialize=False, unique=True)),
        ...
        migrations.CreateModel(
            name='Order',
            fields=[
                ('id', models.CharField(blank=True, default='615725', editable=False, max_length=6, primary_key=True, serialize=False, unique=True)),
                ('created', models.DateTimeField(auto_now_add=True)),
                ('updated', models.DateTimeField(auto_now=True)),
                ('paid', models.BooleanField(default=False)),
                ('braintree_id', models.CharField(blank=True, max_length=150)),
